...
if __name__ == "__main__":
    ...
    parser_summary.add_argument("--nthreads", type=int, help="Number of threads to use (default=1)", default=1)
    parser_summary.add_argument("--meth", help="Whether to trim chrom names (default: False)", default=False, action="store_true")
    parser_summary.add_argument("--progressbar", help="Whether show progress bar (default: False)", default=False, action="store_true")
    parser_summary.add_argument("--verbose", help="Whether to be verbose (default: False)", default=False, action="store_true")
    ...
    parser_cnv.add_argument("--noqcfail", help="Whether to to remove qcfail flag (default: False)", default=False, action="store_true")
